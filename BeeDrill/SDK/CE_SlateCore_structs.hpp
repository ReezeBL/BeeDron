...
struct FComboButtonStyle : public FSlateWidgetStyle
{
	...
	struct FSlateColor                                 DownArrowColorAndOpacity;                                 // 0x0340(0x0028) (Edit, BlueprintVisible)
	struct FSlateBrush                                 MenuBorderBrush;                                          // 0x0368(0x0090) (Edit, BlueprintVisible)
	struct FMargin                                     MenuBorderPadding;                                        // 0x03F8(0x0010) (Edit, BlueprintVisible)
};
...
{
	struct FComboButtonStyle                           ComboButtonStyle;                                         // 0x0008(0x0408) (Edit, BlueprintVisible)
	struct FSlateSound                                 PressedSlateSound;                                        // 0x0410(0x0018) (Edit, BlueprintVisible)
	struct FSlateSound                                 SelectionChangeSlateSound;                                // 0x0428(0x0018) (Edit, BlueprintVisible)
	struct FName                                       PressedSound;                                             // 0x0440(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FName                                       SelectionChangeSound;                                     // 0x0448(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
};
