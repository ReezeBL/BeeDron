...
{
	bool                                               InitialReceived;                                          // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	TArray<int>                                        ComponentEndIndex;                                        // 0x0008(0x0010) (ZeroConstructor)
	TArray<uint16_t>                                   HiddenOnServer;                                           // 0x0018(0x0010) (ZeroConstructor)
};
