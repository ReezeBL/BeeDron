...
#include "CE_LevelSequence_parameters.hpp"
...
// DelegateFunction LevelSequence.LevelSequenceActor.SignalSequencePlayerReadyDelegate__DelegateSignature
// (MulticastDelegate, Public, Delegate)
// Parameters:
// class ULevelSequencePlayer*    NewSequencePlayer              (Parm, ZeroConstructor, IsPlainOldData)

void ALevelSequenceActor::SignalSequencePlayerReadyDelegate__DelegateSignature(class ULevelSequencePlayer* NewSequencePlayer)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction LevelSequence.LevelSequenceActor.SignalSequencePlayerReadyDelegate__DelegateSignature");

	ALevelSequenceActor_SignalSequencePlayerReadyDelegate__DelegateSignature_Params params;
	params.NewSequencePlayer = NewSequencePlayer;
