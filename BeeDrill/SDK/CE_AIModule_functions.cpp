...
#include "CE_AIModule_parameters.hpp"
...
// Function AIModule.PathFollowingComponent.SetStopMovementOnFinish
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           bEnable                        (Parm, ZeroConstructor, IsPlainOldData)

void UPathFollowingComponent::SetStopMovementOnFinish(bool bEnable)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.PathFollowingComponent.SetStopMovementOnFinish");

	UPathFollowingComponent_SetStopMovementOnFinish_Params params;
...
// Function AIModule.PathFollowingComponent.SetBlockDetectionState
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                           bEnable                        (Parm, ZeroConstructor, IsPlainOldData)
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.PathFollowingComponent.SetBlockDetectionState");

	UPathFollowingComponent_SetBlockDetectionState_Params params;
	params.bEnable = bEnable;
...
// Function AIModule.PathFollowingComponent.SetBlockDetection
// (Final, Native, Public, BlueprintCallable)
// Parameters:
...
void UPathFollowingComponent::SetBlockDetection(float DistanceThreshold, float Interval, int NumSamples)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.PathFollowingComponent.SetBlockDetection");

	UPathFollowingComponent_SetBlockDetection_Params params;
...
// Function AIModule.PathFollowingComponent.IsStopMovementOnFinishActive
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UPathFollowingComponent::IsStopMovementOnFinishActive()
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.PathFollowingComponent.IsStopMovementOnFinishActive");

	UPathFollowingComponent_IsStopMovementOnFinishActive_Params params;
...
// Function AIModule.PathFollowingComponent.IsBlockDetectionActive
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UPathFollowingComponent::IsBlockDetectionActive()
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.PathFollowingComponent.IsBlockDetectionActive");

	UPathFollowingComponent_IsBlockDetectionActive_Params params;
...
// class UClass*                  ControllerClass                (Parm, ZeroConstructor, IsPlainOldData)
...
class APawn* UAIBlueprintHelperLibrary::STATIC_SpawnAIFromClass(class UObject* WorldContextObject, class UClass* PawnClass, class UClass* ControllerClass, class UBehaviorTree* BehaviorTree, const struct FVector& Location, const struct FRotator& Rotation, bool bNoCollisionFail)
{
