...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	int                                                ResetInternalTimeCounter;                                 // 0x0070(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
	class UBlendSpaceBase*                             BlendSpace;                                               // 0x0078(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	int                                                InternalResetInternalTimeCounter;                         // 0x0128(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
	struct FPoseLink                                   BasePose;                                                 // 0x0130(0x0018) (Edit, BlueprintVisible)
	int                                                LODThreshold;                                             // 0x0148(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FName                                       SourceSocketName;                                         // 0x0160(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	float                                              NormalizedTime;                                           // 0x0130(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x1A0];                                     // 0x03E0(0x01A0) MISSED OFFSET
};
