...
#include "CE_OnlineSubsystemUtils_structs.hpp"
...
public:
	...
	class UFindSessionsCallbackProxy* STATIC_FindSessions(class UObject* WorldContextObject, class APlayerController* PlayerController, int MaxResults, bool bUsePresence, bool bUseLAN, TEnumAsByte<EFindSessionOfficial> eFindOfficial, TEnumAsByte<EFindSessionServerSet> eServerSet);
};
...
// 0x0020 (0x33718 - 0x336F8)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x336F8(0x0020) MISSED OFFSET
...
public:
	...
	class UObject*                                     WorldContextObject;                                       // 0x0168(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UNetDriver*                                  NetDriver;                                                // 0x03E0(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	EBeaconConnectionState                             ConnectionState;                                          // 0x0400(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5F];                                      // 0x0401(0x005F) MISSED OFFSET
...
public:
	...
	class FString                                      DestSessionId;                                            // 0x0520(0x0010) (ZeroConstructor)
...
{
public:
	class FString                                      BeaconTypeName;                                           // 0x03D0(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x03E0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03E8(0x0010) (ZeroConstructor)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x03F8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x140];                                     // 0x0400(0x0140) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0540(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0541(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0544(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0548(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x278];                                     // 0x0028(0x0278) MISSED OFFSET
	bool                                               bIsFromInvite;                                            // 0x02A0(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bHandlingDisconnect;                                      // 0x02A1(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0xE];                                       // 0x02A2(0x000E) MISSED OFFSET
