...
#include "CE_Niagara_structs.hpp"
...
{
public:
	class UNiagaraComponent*                           NiagaraComponent;                                         // 0x03D0(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
