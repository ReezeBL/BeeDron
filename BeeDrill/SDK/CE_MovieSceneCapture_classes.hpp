...
#include "CE_MovieSceneCapture_structs.hpp"
...
{
public:
	bool                                               bAutoStartCapture;                                        // 0x0250(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xB];                                       // 0x0251(0x000B) MISSED OFFSET
	struct FGuid                                       PrerequisiteActorId;                                      // 0x025C(0x0010) (IsPlainOldData)
