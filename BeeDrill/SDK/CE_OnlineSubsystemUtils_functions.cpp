...
#include "CE_OnlineSubsystemUtils_parameters.hpp"
...
// bool                           bUseLAN                        (Parm, ZeroConstructor, IsPlainOldData)
// TEnumAsByte<EFindSessionOfficial> eFindOfficial                  (Parm, ZeroConstructor, IsPlainOldData)
// TEnumAsByte<EFindSessionServerSet> eServerSet                     (Parm, ZeroConstructor, IsPlainOldData)
// class UFindSessionsCallbackProxy* ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class UFindSessionsCallbackProxy* UFindSessionsCallbackProxy::STATIC_FindSessions(class UObject* WorldContextObject, class APlayerController* PlayerController, int MaxResults, bool bUsePresence, bool bUseLAN, TEnumAsByte<EFindSessionOfficial> eFindOfficial, TEnumAsByte<EFindSessionServerSet> eServerSet)
{
	...
	params.bUseLAN = bUseLAN;
	params.eFindOfficial = eFindOfficial;
	params.eServerSet = eServerSet;
