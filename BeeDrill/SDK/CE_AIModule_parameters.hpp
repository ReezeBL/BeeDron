...
struct UPathFollowingComponent_SetStopMovementOnFinish_Params
{
	bool                                               bEnable;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function AIModule.PathFollowingComponent.SetBlockDetectionState
struct UPathFollowingComponent_SetBlockDetectionState_Params
{
	bool                                               bEnable;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function AIModule.PathFollowingComponent.SetBlockDetection
struct UPathFollowingComponent_SetBlockDetection_Params
{
...
struct UPathFollowingComponent_IsStopMovementOnFinishActive_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function AIModule.PathFollowingComponent.IsBlockDetectionActive
struct UPathFollowingComponent_IsBlockDetectionActive_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
