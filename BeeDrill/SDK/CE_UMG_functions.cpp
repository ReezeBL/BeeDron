...
void UComboBoxString::SetSelectedOption(const class FString& Option, TEnumAsByte<ESelectInfo> SelectInfo)
{
...
// bool                           focusMenu                      (ConstParm, Parm, ZeroConstructor, IsPlainOldData)

void UComboBoxString::SetIsOpen(bool IsOpen, bool focusMenu)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.ComboBoxString.SetIsOpen");
...
// Function UMG.ScrollBox.ScrollWidget
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                          Ammount                        (Parm, ZeroConstructor, IsPlainOldData)

void UScrollBox::ScrollWidget(float Ammount)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.ScrollBox.ScrollWidget");

	UScrollBox_ScrollWidget_Params params;
