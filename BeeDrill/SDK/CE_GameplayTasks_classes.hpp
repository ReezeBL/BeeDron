...
#include "CE_GameplayTasks_structs.hpp"
...
public:
	...
	struct FScriptMulticastDelegate                    OnClaimedResourcesChange;                                 // 0x0148(0x0010) (BlueprintVisible, ZeroConstructor, InstancedReference)
