...
#include "CE_Foliage_parameters.hpp"
...
// Function Foliage.InstancedFoliageActor.UpdateClientStateMulticast
// (Final, Net, NetReliable, Native, Event, NetMulticast, Private)
// Parameters:
// unsigned char                  FoliageComponentIndex          (Parm, ZeroConstructor, IsPlainOldData)
// TArray<uint16_t>               InHiddenInstances              (ConstParm, Parm, ZeroConstructor, ReferenceParm)
// TArray<uint16_t>               InUnhiddenInstances            (ConstParm, Parm, ZeroConstructor, ReferenceParm)

void AInstancedFoliageActor::UpdateClientStateMulticast(unsigned char FoliageComponentIndex, TArray<uint16_t> InHiddenInstances, TArray<uint16_t> InUnhiddenInstances)
{
	static auto fn = UObject::FindObject<UFunction>("Function Foliage.InstancedFoliageActor.UpdateClientStateMulticast");

	AInstancedFoliageActor_UpdateClientStateMulticast_Params params;
	params.FoliageComponentIndex = FoliageComponentIndex;
	params.InHiddenInstances = InHiddenInstances;
	params.InUnhiddenInstances = InUnhiddenInstances;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Foliage.InstancedFoliageActor.OnRep_ReplicatedRespawnParams");

	AInstancedFoliageActor_OnRep_ReplicatedRespawnParams_Params params;
